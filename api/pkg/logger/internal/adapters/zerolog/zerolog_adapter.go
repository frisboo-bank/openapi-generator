...
func (z *zerologAdapter) logWithFields(evt *zerolog.Event, msg string, fields contracts.Fields) {
...
func (z *zerologAdapter) Debugw(msg string, fields contracts.Fields) {
	z.logWithFields(z.logger.Debug(), msg, fields)
}
...
func (z *zerologAdapter) Infow(msg string, fields contracts.Fields) {
	z.logWithFields(z.logger.Info(), msg, fields)
}
...
func (z *zerologAdapter) Errorw(msg string, fields contracts.Fields) {
	z.logWithFields(z.logger.Error(), msg, fields)
}
...
func (z *zerologAdapter) WithName(name string) {
	newLogger := z.logger.With().Str("logger", name).Logger()
	z.logger = &newLogger
}
...
func (z *zerologAdapter) Type() loggertype.LoggerType { return loggertype.LoggerTypes.ZEROLOG }
